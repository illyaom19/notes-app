...
test("widget type policy exports expected supported runtime types", () => {
  assert.deepEqual([...SUPPORTED_WIDGET_TYPES], ["expanded-area", "reference-popup", "pdf-document", "diagram"]);
...
test("creation intent policy keeps manual and internal intents explicit", () => {
  assert.deepEqual([...USER_CREATION_TYPES], ["expanded-area", "snip", "pdf-document", "diagram"]);
